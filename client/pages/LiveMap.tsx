                    ...
                    >
                      ...
                      <div className="text-xs text-muted-foreground space-y-1">
                        ...
                        <div className="flex justify-between">
                          <span>Updated:</span>
                          <span>
                            {formatTimeAgo(vehicle.status.lastUpdate)}
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="h-full bg-gradient-to-br from-blue-100 to-green-100 rounded-lg flex items-center justify-center relative border-2 border-dashed border-blue-200">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-blue-600 mb-4">
                      Real map integration would show vehicles at:
                    </p>
                        ...
                        <CardContent className="space-y-3">
                          <div className="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                {formatSpeed(selectedVehicle.location.speed)}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                {selectedVehicle.status.ignitionStatus
                                  ? "On"
                                  : "Off"}
                              </span>
                            </div>
                          ...
                          <div className="space-y-2 text-xs">
                            ...
                            <div className="flex justify-between">
                              ...
                              <span>
                                {formatTimeAgo(
                                  selectedVehicle.status.lastUpdate,
                                )}
                              </span>
                            </div>
                          </div>
                          ...
                          <Dialog>
                            ...
                            <DialogContent className="max-w-2xl">
                              <DialogHeader>
                                <DialogTitle>
                                  Trip History - {selectedVehicle.name}
                                </DialogTitle>
                              </DialogHeader>
                              <div className="space-y-4">
                                      ...
                                      <div className="mt-3 pt-3 border-t">
                                        ...
                                        <div className="space-y-1 text-xs">
                                          <div>
                                            Start:{" "}
                                            {formatCoordinates(
                                              trip.startLocation[0],
                                              trip.startLocation[1],
                                            )}
                                          </div>
                                          <div>
                                            End:{" "}
                                ...
                                {mockTripData.filter(
                                  (trip) =>
                                    trip.deviceId === selectedVehicle.deviceId,
                                ).length === 0 && (
